...
export default function SignupPage() {
  ...
  const t =
    language === "ar"
      ? {
          title: "إنشاء حساب",
          subtitle: "أنشئ حسابك وابدأ التعلم الآن",
          name: "الاسم الكامل",
  ...
  return (
    <div className="min-h-screen flex bg-[#3E0000] py-28">
      {/* Left Side */}
      <div className="hidden lg:flex w-1/2 items-center justify-center text-white p-16">
        <div>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-primary p-8 rounded-r-3xl shadow-[0_-15px_25px_-5px_rgba(0,0,0,0.3)]">
        ...
        >
          ...
          <p className="text-center text-sm">
            {t.haveAccount}{" "}
            <a href="/login" className="text-[#3E0000] font-semibold">
              {t.login}
            </a>
          </p>
        </motion.div>
